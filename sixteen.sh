...
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "system" "ro.build.display.id" "ProjectDozG Official Stable Build 1 - a22                    ${B_ID} ${B_V}"
BUILD_PROP "$FIRM_DIR/$TARGET_DEVICE" "product" "ro.build.display.id" "ProjectDozG Official Stable Build 1 - a22                    ${B_ID} ${B_V}"
